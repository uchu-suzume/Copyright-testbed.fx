...
uniform int cLayer_Select <
    ...
    ui_items = 
               ...
               "Custom\0"
               ;
    ui_bind = "_Copyright_Test_Texture_Source";
> = 0;
...
#elif _Copyright_Test_Texture_Source == 18 // FFXIV Gill Sans Framed
...
#elif _Copyright_Test_Texture_Source == 19 // FFXIV Gill Sans Framed 2
...
#define ScaleSize float2(float2(_SOURCE_COPYRIGHT_Test_SIZE) * cLayer_Scale / BUFFER_SCREEN_SIZE)
...
technique Copyright_test< ui_label = "Copyright X"; >
{
    pass pass0
    {
