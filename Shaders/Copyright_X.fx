...
'-------------------/
    ...
    * Experimental features added:
    ...
    Version 1.x by Marot Satil & uchu suzume
    + Implemented *Tex.fxh preprocessor macros.
      Regard to this changes, texture source-related structure has been redesigned and divided into
      different lists for each game title, so that can switch between them.
    * Added gaussian layer radius mode that the maximum capability to thickness.
    * Changed blending method of BG Blend mode to more legitimate.
*/
...
#define TEXFORMAT RGBA8
  ...
  #elif __APPLICATION__ == 0x31d39829 // <-Double check this hash please.
    #undef TEXTURE_SELECTION
...
//If you get an error about _SOURCE_COPYRIGHT_FILE, check GShade referring to a Source Number that exists.
...
technique Copyright_X< ui_label = "Copyright X"; >
{
    pass pass0
    {
